...
export function TopBar() {
  ...
  // ── Single source of truth: sync data-theme on <html> for ALL pages ──
  useEffect(() => {
    document.documentElement.setAttribute('data-theme', isDark ? 'dark' : 'light');
    // Also keep the legacy .dark class for Tailwind dark: utilities
  ...
  return (
    ...
    >
      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        {/* ── Single Theme Toggle for the entire app ── */}
        <button
          onClick={toggleDark}
